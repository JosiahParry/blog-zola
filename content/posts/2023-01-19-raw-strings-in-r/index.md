...
The one thing about Python I actually really like is the ability to use
...
Using the backslash is so annoying because it’s also an escape
...
<span class="column-margin margin-aside">How can I get the R-devel news?
I’m on the mailing list and get it once a week and it’s like “Re: memory
leak in png() \` not this stuff. Tips?</span>

It was announced in the [news for version
4.0.0](https://cran.r-project.org/doc/manuals/r-devel/NEWS.html).
...
<span class="column-margin margin-aside">It kinda looks like a
crab</span>
