...
As a side project, I’m trying to build a full stack web app with auth,
...
I’m doing all of this through the Rust [leptos](https://leptos.dev/)
framework. But the challenge is that javascript is always present and I
can’t really get away from it for some things and making the two
...
something called
[wasm-bindgen](https://rustwasm.github.io/docs/wasm-bindgen/). This lets
you call javascript functions from Rust.

Part of what I’m playing with involves [webR](https://webr.r-wasm.org/).
...
On pages where this code isn’t needed or uses errors can abound which
will break client side reactivity in leptos.

Now it’s a matter of having to figure out how to appropriately import
...
is fine. I’m unsure how I will handle others.
