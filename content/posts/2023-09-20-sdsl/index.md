...
I feel very fortunate to have been invited to the first Spatial Data
Science Across Languages (SDSL) workshop at the University of Münster. I
...
In general, the theme of the workshop was “standards.” We need standards
...
“standards.” Arrow gets conflated at many thing all at once—I do that.
...
This is a massive productivity improvement. There’s no computation cost
in converting between one format to another saving time, energy, and
money.

<div class="aside">

There’s a good chance that in order to adopt Arrow in `{sf}` there will
...
I also think if we can move towards a “trait-driven” approach to spatial
data frames, we can support both GeoArrow geometries as well as current
`sfc` objects.

[Read my spatial data frame
manifesto.](https://github.com/JosiahParry/sdf)
...
wars](https://wesmckinney.com/blog/the-problem-with-the-data-science-language-wars/)

[Kyle Barron](https://github.com/kylebarron) demonstrated really cool
example use-case where he created GeoArrow arrays using
[GeoPolars](https://github.com/geopolars/geopolars). That array was then
...
Additionally, we are seeing [WebAssembly](https://webassembly.org/)
proliferate in the data science community.
[WebR](https://webr.r-wasm.org/) provides R users with the ability to
execute R in the browser. This is also possible in Python, Rust, Go, and
I’m sure many others. Each language can be compiled to be used in the
...
Science](https://r-spatial.org/book/01-hello.html#sec-support) (SDS) for
more on this topic.
...
context of spatial interpolation. I’m still quite unclear on how to
conceptualize intensive and extensive variables. [Tobias
G](https://github.com/MobiTobi) pointed out that these terms come from
physics and provided a useful non-geometry motivating example.

> “The price of an ingot of gold is an extensive property and its
> temperature would be intensive.”
...
now worth less than the whole. But, assuming the room temperature didn’t
...
A
[Domain](https://desktop.arcgis.com/en/arcmap/latest/manage-data/geodatabases/an-overview-of-attribute-domains.htm)
...
3.3](https://github.com/OSGeo/gdal/releases/tag/v3.3.0).
...
there should be a GeoArrow table (data frame) format spec too? I’d like
...
The conversation was kicked off by this “motivating example.”
...
R supports spherical geometries by using [Google’s S2
library](https://r-spatial.github.io/s2/). Python is presently building
out support for S2. Some operations like buffering still aren’t made
available by S2.
...
spatial weights matrixes. We didn’t really discuss the “how” of holding
...
[Martin](https://martinfleischmann.net/) mentioned that in Pysal they
...
I’m about to hop on a flight back to the US now—10 hours without
...
- [Martin’s SDSL blog
  post](https://martinfleischmann.net/a-note-on-spatial-data-science-across-languages-vol.1/)
