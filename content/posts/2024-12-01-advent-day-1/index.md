...
[`{extendr}`](https://extendr.github.io/user-guide/complete-example.html).

------------------------------------------------------------------------

I tend to always do just the first day of the advent of code. It is not
my cup of tea. I don’t enjoy word problems, or sudoku, or the like. But
I do like it when people learn. I find many people use this as a time to
learn a new language.

This morning I did the [Advent of Code Day
1](https://adventofcode.com/2024/day/1) in both R and Rust. I’ll discuss
...
Let’s try rewriting it using a pipe so it can be a bit easier to
process:
...
{haven}](https://josiahparry.com/posts/2019-12-14-spss-haven)
...
completely honest. I’m still terrible with using readers in Rust so I
used ChatGPTs help. I’m not going to lie about it.
...
[`{dotty}`](https://kevinushey.github.io/dotty/) or
[`{zeallot}`](https://github.com/r-lib/zeallot). My preference is for
dotty, personally.
...
techniques you’re not familiar with. Here is the solution in all of its
...
not think about. Since this is a named vector, we can extract it’s
elements by name.
...
That’s it. While it is much more code, it feels much easier to read and
...
> **Note**
>
> This isn’t optimized to be fast code and we’re not even using R native
