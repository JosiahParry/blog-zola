...
I have been wanting to learn a low level language for quite some time.
...
[`rextendr`](https://extendr.github.io/rextendr/) a way to incorporate
Rust into R packages. With that Rust became a real candidate language to
learn.

The [@hrbrmstr](https://twitter.com/hrbrmstr) provided some sweet words
of encouragement over twitter, [an example
repo](https://github.com/hrbrmstr/kev-push) to reference, and provided
ideas on how to [start learning
Rust](https://dailyfinds.hrbrmstr.dev/p/knowledge-drop-learning-rust).

I spent some time with [“The
Book”](https://doc.rust-lang.org/stable/book/) to wrap my head around
the basics. I then spent some time writing a chess [FEN
parser](https://github.com/josiahparry/fen). I wrote a FEN parser. I
...
line. But that’s actually okay because of the Rust compiler is the best
teacher I’ve ever had.

When you make a mistake in Rust, the compiler will tell you *exactly*
where that mistake is coming from—literally the line and column
...
[`sdf`](https://github.com/JosiahParry/sdf/) package.
