...
I’ve been building a *thing* with [Leptos](https://leptos.dev/) and
[Tailwind CSS](https://tailwindcss.com/) for a while.
...
I am using
[`pulldown-cmark`](https://github.com/pulldown-cmark/pulldown-cmark) to
...
involve `wasm-bindgen` and other pain, but it doesn’t.
...
Once you’ve downloaded the `highlight` folder. Move it into your leptos
...
Note 👈🏼 that I chose the `nord.css` file. You can choose ant of the ones
