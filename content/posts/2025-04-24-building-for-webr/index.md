...
We’ve recently [added WebR
support](https://github.com/extendr/rextendr/pull/431) for
[extendr](https://extendr.github.io/).

<div class="alert-tip">

[WebR](https://docs.r-wasm.org/webr/latest/) is a distribution of the R
programming language that runs natively in
[WebAssembly](https://webassembly.org/). WebAssembly is binary format
...
Typically, folks rely on [R-universe](https://r-universe.dev/) to build
...
Thanks to [George
Stagg](https://github.com/r-wasm/rwasm/issues/50#issuecomment-2827097396)
