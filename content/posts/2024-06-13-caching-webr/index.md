...
I am developing Rust bindings to [WebR](https://webr.r-wasm.org/).
...
[wasm-bindgen](https://rustwasm.github.io/docs/wasm-bindgen/) which
creates bindings to JavaScript.

The WIP Rust crate is called
[`webr-js-rs`](https://github.com/JosiahParry/webr-js-rs/).

<div class="alert-tip">

I’m building these bindings to support
**[flrsh.dev](https://flrsh.dev/)**.
...
- There is an [outstanding
  issue](https://github.com/r-wasm/webr/issues/166) on the WebR GitHub.
...
[@GeorgeStagg](https://github.com/georgestagg) pointed out

> “The webR CDN assets under /latest/ are intentionally served with
...
> “The longer-term builds under e.g. /v0.3.3/ are served with the HTTP
> header cache-control: max-age=604800, and so the webR assets should
> automatically be **cached by browsers for 1 week**.”
