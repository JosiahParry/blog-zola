...
This blog post is based on my most recent YouTube video. Please give it
a watch!
...
I’ve been grinding on a new tool for a few months now. And I’m hyped to
formally introduce you to it. It’s called
[Valve](https://valve.josiahparry.com) And Valve is going to make R in
production kick a$$.🔥

We’ve all seen those click bait articles saying “Don’t Put R in
production” or telling you that R can’t make machine learning models for
production. Those “hot takes” are uninformed and can be applied to other
languages such as Python. That’s a bunch of malarkey.

[<img src="images/paste-1.png" style="width:50.0%"
data-fig-align="center" />](https://towardsdatascience.com/dont-use-r-in-production-e2f4c9dd4a7b)

Let’s get right down to it. Let’s talk “production.” And let me be
clear: R belongs in production. But we as the R community need to learn
how to do that and be better advocates.

When I say “production” I’m talking about making your code work with any
other system. And that’s where RESTful APIs come in. If I’ve lost you at
“RESTful”, [watch my previous video
here](https://www.youtube.com/watch?v=w4yHEQWct20&list=UULFX78SUhrloA6Cn3aW_e8C_A&index=22).

<div class="aside">

[<img src="images/paste-15.png" style="width:75.0%"
data-fig-align="center" />](https://www.youtube.com/watch?v=w4yHEQWct20&list=UULFX78SUhrloA6Cn3aW_e8C_A&index=22)

</div>

REST relies on HTTP, which is the foundation of the internet and is a
common tongue. It’s like if Esperanto actually worked. REST APIs provide
a language-agnostic way to expose functionality over the web.

[Plumber](https://www.rplumber.io/) is an R package that converts your R
...
At it’s core Valve is a web server that runs multiple {plumber} APIs in
parallel. Valve spins up and down plumber APIs as needed.

<img src="images/paste-21.png" style="width:75.0%"
data-fig-align="center" />

It’s designed to work with any existing plumber API. And because of that
...
then “serialized” into the correct output type. By default, this is
`json`.
...
personal recommendation. If you don’t have Rust and cargo installed,
don’t worry it is the second easiest language I’ve ever installed.
...
the [github
repository](https://github.com/JosiahParry/youtube-tutorials/tree/main/intro-valve).
...
time. We’ll create a Valve app with 10 workers and plumber APIs.

``` shell
valve -n 10 -w 10
```

You’ll notice that only one API is spawned at the start. This is because
...
We’re going to create a simple function `sleep()` which will call the
zzz endpoint at a specified port for a specified amount of time. We’ll
...
That’s a huge different. That is a lot more performance that we are
...
From the command line we can run `valve –help` to see the arguments that
...
and valve. They do so by wrapping the model into a plumber API. I’ve
created a sample plumber API based on [Julia’s recent Tidy Tuesday
screencast in which she creates an XGBoost
model](https://juliasilge.com/blog/childcare-costs/).

![](images/paste-14.png)

I’ve taken this example and used vetiver to create a plumber API to
...
repo](https://github.com/JosiahParry/youtube-tutorials/tree/main/intro-valve).

</div>

To make this into a Valve app all we need to do is pass provide the
plumber API file to valve and we’re on our way! I’ve written some simple
