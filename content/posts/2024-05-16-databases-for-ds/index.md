...
It’s been coming up a lot recently, or, maybe, I’ve just been focused on
...
data scientists don’t really know how to make that leap. What do they
need to know to make that transition?

For many of use in the “know”, we know that there actually isn’t all
...
be helpful for you to know. I’m not going to teach you them here. But
list them out so you can google it. And truthfully, you already know
what these are but you don’t know the terminology.
...
4.  Schemas vs. tables for organizational purposes
5.  Views vs tables (this is handy for making tables to be consumed by
    BI / other things)
6.  Table indexes and what they are (that way you can know when you
    might need them)

## Why you might not actually need a full RDBMS

With the ubiquity of parquet and tools like apache arrow and DuckDB,
there’s a good chance that for what you want to accomplish in your
analytical workflow, you don’t need a fully fledged database. Organized
...
capacity. You don’t need to read it all into memory, actually.
...
Apache Arrow. It’s likely all you need.
