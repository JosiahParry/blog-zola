...
The incorporation of spatially dependent variables in a machine learning
model can greatly improve the model’s performance. These features can
...
![](2024-05-23-spatial-ml-prediction_files/figure-commonmark/unnamed-chunk-2-1.png)
...
![](2024-05-23-spatial-ml-prediction_files/figure-commonmark/unnamed-chunk-2-2.png)
...
1.  Use the original spatial features to derive the spatial varaibles on
    the out of sample data.
2.  Grow the spatial index trees
3.  Calculate the spatial variables on the context of the new
    out-of-sample data.
...
2.  Calculate the spatial lag of the neighborhood in the context of the
    training dataset
...
3.  Calculate spatial lag in the context of both training and testing
    dataset
