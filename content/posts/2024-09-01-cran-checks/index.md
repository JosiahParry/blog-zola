...
Commit the file to GitHub and voilá.

### How this works

Since CRAN can’t be bothered to email us when they remove a package, we
...
The
[`ricochet-rs/cran-checks`](https://github.com/ricochet-rs/cran-checks)
...
url
[`https://ricochet-rs.github.io/cran-checks/b64.json`](https://ricochet-rs.github.io/cran-checks/b64.json).

The GitHub Action checks for your package’s json file and looks at all
...
install the packages, they weren’t on CRAN. It was a very bad look.

How were they supposed to know the packages we’re gone? They were there
...
let you know if your package is failing, why doesn’t CRAN?
...
failing. However, this would require funding which I don’t have.
