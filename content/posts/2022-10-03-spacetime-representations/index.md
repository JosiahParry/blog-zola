...
Pebesma’s 2012 article [“spacetime: Spatio-Temporal Data in
R”](https://www.jstatsoft.org/article/view/v051i07) and Thomas Lin
Pederson’s [tidygraph
package](https://ggraph.data-imaginist.com/articles/tidygraph.html).
...
- “**Time-wide**: Where different columns reflect different moments in
  time.
...
The “long format” is what we may consider “tidy” per [Wickham
(2014)](https://www.jstatsoft.org/article/view/v059i10). In this case,
both time and space are variables with unique combinations as rows.

Pebesma further qualifies spatial data representation into a “sparse
...
Very recently in an r-spatial [blog post, “Vector Data
Cubes”](https://r-spatial.org/r/2022/09/12/vdc.html#multiple-long-table-forms-database-normalization),
...
The spacetime class in [sfdep](https://sfdep.josiahparry.com) is in
...
of [tidygraph](https://tidygraph.data-imaginist.com/) in mind.
...
```
     ...
     * <chr>    <dttm>                <dbl>  <int>
     1 001      2025-12-03 14:46:55  0.469       1
     2 001      2025-12-03 16:01:55  0.531       2
     3 001      2025-12-03 17:16:55 -2.30        3
     4 001      2025-12-03 18:31:55 -0.0152      4
     5 001      2025-12-03 19:46:55  2.25        5
     6 002      2025-12-03 14:46:55 -0.0245      6
     7 002      2025-12-03 16:01:55  0.313       7
     8 002      2025-12-03 17:16:55 -0.263       8
     9 002      2025-12-03 18:31:55  0.158       9
    10 002      2025-12-03 19:46:55  0.436      10

</details>

## Qualifiers

I don’t think my spacetime class is the panacea. I don’t have the
...
There’s a new R package called `cubble` for spatio-temporal data. I’ve
