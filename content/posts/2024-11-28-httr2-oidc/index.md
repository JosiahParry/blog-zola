...
I am working on a rust project that I want to use OpenID Connect for.
...
[OpenID Connect
(OIDC)](https://openid.net/developers/how-connect-works/) is an
...
[Auth0](https://auth0.com/) and made an application. I’ll store the url
...
> `httr2_oauth_client` class in [`{httr2}`](https://httr2.r-lib.org).
>
> ``` r
...
Now that I’m looking at this again, it may be worth storing the the
authorization endpoint into the client too…
...
The [standard
claim](https://openid.net/specs/openid-connect-basic-1_0.html#StandardClaims)
...
this. I utilize the [`{b64}`](https://extendr.github.io/b64/) package
for fast decoding. Then use
[`{yyjsonr}`](https://coolbutuseless.github.io/package/yyjsonr/index.html)
